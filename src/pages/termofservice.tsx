...
export default function TermsOfService() {
    return (
        <div style={{ padding: "100px 24px", maxWidth: "800px", margin: "0 auto", color: "#1a1f2e", lineHeight: "1.6", fontFamily: "'Inter', system-ui, sans-serif" }}>
            <h1 style={{ fontSize: "2.5rem", fontWeight: "800", marginBottom: "8px", color: "#0d1117", letterSpacing: "-0.02em" }}>Terms of Service (ToS)</h1>
            <p style={{ color: "#64748b", marginBottom: "40px" }}>Last updated: February 2026</p>

            <section style={{ marginBottom: "32px" }}>
                <h2 style={{ fontSize: "1.25rem", fontWeight: "700", marginBottom: "12px", color: "#0d1117" }}>1. Acceptance of Terms</h2>
            ...
            <section style={{ marginBottom: "32px" }}>
                <h2 style={{ fontSize: "1.25rem", fontWeight: "700", marginBottom: "12px", color: "#0d1117" }}>2. Scope of Service</h2>
            ...
            <section style={{ marginBottom: "32px" }}>
                <h2 style={{ fontSize: "1.25rem", fontWeight: "700", marginBottom: "12px", color: "#0d1117" }}>3. No Legal or Tax Advice</h2>
            ...
            <section style={{ marginBottom: "32px" }}>
                <h2 style={{ fontSize: "1.25rem", fontWeight: "700", marginBottom: "12px", color: "#0d1117" }}>4. User Obligations & Accuracy</h2>
                ...
                <div style={{ paddingLeft: "20px", marginTop: "12px" }}>
                    <p style={{ marginBottom: "8px" }}><strong style={{ color: "#0d1117" }}>Calculation Errors:</strong> If you enter incorrect data leading to underpaid stamp duty, you are liable for any penalties or additional payments demanded by LHDN.</p>
                    <p style={{ marginBottom: "8px" }}><strong style={{ color: "#0d1117" }}>Identity:</strong> You must use your real identity. Use of the App for money laundering or fraudulent tenancy creation is strictly prohibited.</p>
                </div>
            </section>

            <section style={{ marginBottom: "32px" }}>
                <h2 style={{ fontSize: "1.25rem", fontWeight: "700", marginBottom: "12px", color: "#0d1117" }}>5. Manual Stamping Process</h2>
                <p>You acknowledge that Zurely currently utilizes a manual submission process for LHDN stamping.</p>
                <div style={{ paddingLeft: "20px", marginTop: "12px" }}>
                    <p style={{ marginBottom: "8px" }}><strong style={{ color: "#0d1117" }}>Timeline:</strong> While we aim for a [3-5] working day turnaround, we are not liable for delays caused by LHDN system downtime, public holidays, or administrative backlogs at the tax office.</p>
                    <p style={{ marginBottom: "8px" }}><strong style={{ color: "#0d1117" }}>Agent Authorization:</strong> By using the Stamping Bridge, you authorize Double D Sdn Bhd and its appointed administrators to act as your agent in submitting documents to the LHDN "MyTax" or "STAMPS" portal.</p>
                </div>
            </section>

            <section style={{ marginBottom: "32px" }}>
                <h2 style={{ fontSize: "1.25rem", fontWeight: "700", marginBottom: "12px", color: "#0d1117" }}>6. Payment & Fees</h2>
            ...
            <section style={{ marginBottom: "32px" }}>
                <h2 style={{ fontSize: "1.25rem", fontWeight: "700", marginBottom: "12px", color: "#0d1117" }}>7. Limitation of Liability</h2>
            ...
            <section style={{ marginBottom: "32px" }}>
                <h2 style={{ fontSize: "1.25rem", fontWeight: "700", marginBottom: "12px", color: "#0d1117" }}>8. Termination</h2>
            ...
            <section style={{ marginBottom: "32px" }}>
                <h2 style={{ fontSize: "1.25rem", fontWeight: "700", marginBottom: "12px", color: "#0d1117" }}>9. Governing Law</h2>
